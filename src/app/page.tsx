      ...
      testimonials={[
        {
          name: "Elena Vance",
          handle: "@elena_v",
          testimonial: "Transformed our operations in record time.",
          rating: 5,
        ...
        },
        {
          name: "Marcus Thorne",
          handle: "@m_thorne",
          testimonial: "Unparalleled precision and speed.",
          rating: 5,
        ...
        },
        {
          name: "Sarah Chen",
          handle: "@schen_tech",
          testimonial: "The best AI integration tool we've used.",
          rating: 5,
        ...
        },
        {
          name: "David Miller",
          handle: "@dave_m",
          testimonial: "Changed our development pipeline forever.",
          rating: 5,
        ...
        },
        {
          name: "Jessica Lee",
          handle: "@jess_lee",
          testimonial: "Incredible insights, immediate results.",
          rating: 5,
      ...
      avatars={[
        {
          ...
          alt: "Portrait of leader 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/man-black-suit-having-his-arms-crossed_23-2148401474.jpg",
          alt: "Portrait of leader 2",
        },
        {
          ...
          alt: "Portrait of leader 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-young-confident-man_176474-85922.jpg",
          alt: "Portrait of leader 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/black-businessman-happy-expression_1194-2623.jpg",
          alt: "Portrait of leader 5",
        },
      ]}
      marqueeItems={[
        {
